<?php $auth = Zend_Auth::getInstance()->setStorage(new Zend_Auth_Storage_Session('Zend_Auth_User')); ?>
<?php
$filters = array(
// Бренд
	'brands' => array(
...
<div class="breadcrumbsDesign">
    <p>
		...
		<?php
		if (strripos($_SERVER['REQUEST_URI'], 'oils') && strripos($_SERVER['REQUEST_URI'], '.html')) {
			$href = '/oils/';
			$title = '';
...
<?php if (strripos($_SERVER['REQUEST_URI'], 'oils')) { ?>                
			...
			if (isset($_GET['filters']['viscosity'])) {
				foreach ($_GET['filters']['viscosity'] as $getBrand) {
	        ...
	        <script>
	            function isCheckedSearch() {
	                if ($('#typeвакуумное').is(":checked")) {
	                    var listLI = '';
	                    listLI = listLI + '<li id="viscosity68"><label><input type="checkbox" name="filters[viscosity][]" <?php if (isset($viscosityArray["68"])) {
				echo $viscosityArray["68"];
			} ?> value="68">68</label></li>';
	                    listLI = listLI + '<li id="viscosity100"><label><input type="checkbox" name="filters[viscosity][]" value="100" <?php if (isset($viscosityArray["100"])) {
				echo $viscosityArray["100"];
			} ?> >100</label></li>';
	                    listLI = listLI + '<li id="viscosity150"><label><input type="checkbox" name="filters[viscosity][]" value="150" <?php if (isset($viscosityArray["150"])) {
				echo $viscosityArray["150"];
			} ?> >150</label></li>';
	                    $("#viscosityUL").append(listLI);
	                }
	                if ($('#typeгидравлическое').is(":checked")) {
	                    var listLI = '';
	                    listLI = listLI + '<li id="viscosity2"><label><input type="checkbox" name="filters[viscosity][]" value="2" <?php if (isset($viscosityArray["2"])) {
				echo $viscosityArray["2"];
			} ?> >2</label></li>';
	                    listLI = listLI + '<li id="viscosity3"><label><input type="checkbox" name="filters[viscosity][]" value="3" <?php if (isset($viscosityArray["3"])) {
				echo $viscosityArray["3"];
			} ?> >3</label></li>';
	                    listLI = listLI + '<li id="viscosity5"><label><input type="checkbox" name="filters[viscosity][]" value="5" <?php if (isset($viscosityArray["5"])) {
				echo $viscosityArray["5"];
			} ?> >5</label></li>';
	                    listLI = listLI + '<li id="viscosity10"><label><input type="checkbox" name="filters[viscosity][]" value="10" <?php if (isset($viscosityArray["10"])) {
				echo $viscosityArray["10"];
			} ?> >10</label></li>';
	                    listLI = listLI + '<li id="viscosity15"><label><input type="checkbox" name="filters[viscosity][]" value="15" <?php if (isset($viscosityArray["15"])) {
				echo $viscosityArray["15"];
			} ?> >15</label></li>';
	                    listLI = listLI + '<li id="viscosity22"><label><input type="checkbox" name="filters[viscosity][]" value="22" <?php if (isset($viscosityArray["22"])) {
				echo $viscosityArray["22"];
			} ?> >22</label></li>';
	                    listLI = listLI + '<li id="viscosity32"><label><input type="checkbox" name="filters[viscosity][]" value="32" <?php if (isset($viscosityArray["32"])) {
				echo $viscosityArray["32"];
			} ?> >32</label></li>';
	                    listLI = listLI + '<li id="viscosity46"><label><input type="checkbox" name="filters[viscosity][]" value="46" <?php if (isset($viscosityArray["46"])) {
				echo $viscosityArray["46"];
			} ?> >46</label></li>';
	                    listLI = listLI + '<li id="viscosity68"><label><input type="checkbox" name="filters[viscosity][]" value="68" <?php if (isset($viscosityArray["68"])) {
				echo $viscosityArray["68"];
			} ?>>68</label></li>';
	                    listLI = listLI + '<li id="viscosity100"><label><input type="checkbox" name="filters[viscosity][]" value="100" <?php if (isset($viscosityArray["100"])) {
				echo $viscosityArray["100"];
				...
				echo $viscosityArray["150"];
	                    ...
	                    listLI = listLI + '<li id="viscosity220"><label><input type="checkbox" name="filters[viscosity][]" value="220" <?php if (isset($viscosityArray["220"])) {
				echo $viscosityArray["220"];
			} ?> >220</label></li>';
	                    listLI = listLI + '<li id="viscosity320"><label><input type="checkbox" name="filters[viscosity][]" value="320" <?php if (isset($viscosityArray["320"])) {
				echo $viscosityArray["320"];
			} ?> >320</label></li>';
	                    listLI = listLI + '<li id="viscosity460"><label><input type="checkbox" name="filters[viscosity][]" value="460" <?php if (isset($viscosityArray["460"])) {
				echo $viscosityArray["460"];
			} ?> >460</label></li>';
	                    listLI = listLI + '<li id="viscosity680"><label><input type="checkbox" name="filters[viscosity][]" value="680" <?php if (isset($viscosityArray["680"])) {
				echo $viscosityArray["680"];
			} ?> >680</label></li>';
	                    listLI = listLI + '<li id="viscosity1000"><label><input type="checkbox" name="filters[viscosity][]" value="1000" <?php if (isset($viscosityArray["1000"])) {
				echo $viscosityArray["1000"];
			} ?> >1000</label></li>';
	                    $("#viscosityUL").append(listLI);
	                }
	                if ($('#typeмоторное').is(":checked")) {
	                    var listLI = '';
	                    listLI = listLI + '<li id="viscosity0W20"><label><input type="checkbox" name="filters[viscosity][]" value="0W20" <?php if (isset($viscosityArray["0W20"])) {
				echo $viscosityArray["0W20"];
			} ?> >0W20</label></li>';
	                    listLI = listLI + '<li id="viscosity0W30"><label><input type="checkbox" name="filters[viscosity][]" value="0W30" <?php if (isset($viscosityArray["0W30"])) {
				echo $viscosityArray["0W30"];
			} ?> >0W30</label></li>';
	                    listLI = listLI + '<li id="viscosity0W40"><label><input type="checkbox" name="filters[viscosity][]" value="0W40" <?php if (isset($viscosityArray["0W40"])) {
				echo $viscosityArray["0W40"];
			} ?> >0W40</label></li>';
	                    listLI = listLI + '<li id="viscosity5W20"><label><input type="checkbox" name="filters[viscosity][]" value="5W20" <?php if (isset($viscosityArray["5W20"])) {
				echo $viscosityArray["5W20"];
			} ?> >5W20</label></li>';
	                    listLI = listLI + '<li id="viscosity5W30"><label><input type="checkbox" name="filters[viscosity][]" value="5W30" <?php if (isset($viscosityArray["5W30"])) {
				echo $viscosityArray["5W30"];
			} ?> >5W30</label></li>';
	                    listLI = listLI + '<li id="viscosity5W40"><label><input type="checkbox" name="filters[viscosity][]" value="5W40" <?php if (isset($viscosityArray["5W40"])) {
				echo $viscosityArray["5W40"];
			} ?> >5W40</label></li>';
	                    listLI = listLI + '<li id="viscosity5W50"><label><input type="checkbox" name="filters[viscosity][]" value="5W50" <?php if (isset($viscosityArray["5W50"])) {
				echo $viscosityArray["5W50"];
			} ?> >5W50</label></li>';
	                    listLI = listLI + '<li id="viscosity10W30"><label><input type="checkbox" name="filters[viscosity][]" value="10W30" <?php if (isset($viscosityArray["10W30"])) {
				echo $viscosityArray["10W30"];
			} ?> >10W30</label></li>';
	                    listLI = listLI + '<li id="viscosity10W40"><label><input type="checkbox" name="filters[viscosity][]" value="10W40" <?php if (isset($viscosityArray["10W40"])) {
				echo $viscosityArray["10W40"];
			} ?> >10W40</label></li>';
	                    listLI = listLI + '<li id="viscosity10W50"><label><input type="checkbox" name="filters[viscosity][]" value="10W50" <?php if (isset($viscosityArray["10W50"])) {
				echo $viscosityArray["10W50"];
			} ?> >10W50</label></li>';
	                    listLI = listLI + '<li id="viscosity10W60"><label><input type="checkbox" name="filters[viscosity][]" value="10W60" <?php if (isset($viscosityArray["10W60"])) {
				echo $viscosityArray["10W60"];
			} ?> >10W60</label></li>';
	                    listLI = listLI + '<li id="viscosity15W40"><label><input type="checkbox" name="filters[viscosity][]" value="15W40" <?php if (isset($viscosityArray["15W40"])) {
				echo $viscosityArray["15W40"];
			} ?> >15W40</label></li>';
	                    listLI = listLI + '<li id="viscosity15W50"><label><input type="checkbox" name="filters[viscosity][]" value="15W50" <?php if (isset($viscosityArray["15W50"])) {
				echo $viscosityArray["15W50"];
			} ?> >15W50</label></li>';
	                    listLI = listLI + '<li id="viscosity20W20"><label><input type="checkbox" name="filters[viscosity][]" value="20W20" <?php if (isset($viscosityArray["20W20"])) {
				echo $viscosityArray["20W20"];
			} ?> >20W20</label></li>';
	                    listLI = listLI + '<li id="viscosity20W40"><label><input type="checkbox" name="filters[viscosity][]" value="20W40" <?php if (isset($viscosityArray["20W40"])) {
				echo $viscosityArray["20W40"];
			} ?> >20W40</label></li>';
	                    listLI = listLI + '<li id="viscosity20W50"><label><input type="checkbox" name="filters[viscosity][]" value="20W50" <?php if (isset($viscosityArray["20W50"])) {
				echo $viscosityArray["20W50"];
			} ?> >20W50</label></li>';
	                    listLI = listLI + '<li id="viscosity20W60"><label><input type="checkbox" name="filters[viscosity][]" value="20W60" <?php if (isset($viscosityArray["20W60"])) {
				echo $viscosityArray["20W60"];
			} ?> >20W60</label></li>';
	                    listLI = listLI + '<li id="viscosity25W40"><label><input type="checkbox" name="filters[viscosity][]" value="25W40" <?php if (isset($viscosityArray["25W40"])) {
				echo $viscosityArray["25W40"];
			} ?> >25W40</label></li>';
	                    listLI = listLI + '<li id="viscositySAE30"><label><input type="checkbox" name="filters[viscosity][]" value="SAE30" <?php if (isset($viscosityArray["SAE30"])) {
				echo $viscosityArray["SAE30"];
			} ?> >SAE30</label></li>';
	                    $("#viscosityUL").append(listLI);
	                }
	                if ($('#typeтрансмиссионное').is(":checked")) {
	                    var listLI = '';
	                    listLI = listLI + '<li id="viscosity85W90"><label><input type="checkbox" name="filters[viscosity][]" value="85W90" <?php if (isset($viscosityArray["85W90"])) {
				echo $viscosityArray["85W90"];
			} ?> >85W90</label></li>';
	                    listLI = listLI + '<li id="viscosity80W90"><label><input type="checkbox" name="filters[viscosity][]" value="80W90" <?php if (isset($viscosityArray["80W90"])) {
				echo $viscosityArray["80W90"];
			} ?> >80W90</label></li>';
	                    listLI = listLI + '<li id="viscosity80W110"><label><input type="checkbox" name="filters[viscosity][]" value="80W110" <?php if (isset($viscosityArray["80W110"])) {
				echo $viscosityArray["80W110"];
			} ?> >80W110</label></li>';
	                    listLI = listLI + '<li id="viscosity80W140"><label><input type="checkbox" name="filters[viscosity][]" value="80W140" <?php if (isset($viscosityArray["80W140"])) {
				echo $viscosityArray["80W140"];
			} ?> >80W140</label></li>';
	                    listLI = listLI + '<li id="viscosity75W80"><label><input type="checkbox" name="filters[viscosity][]" value="75W80" <?php if (isset($viscosityArray["75W80"])) {
				echo $viscosityArray["75W80"];
			} ?> >75W80</label></li>';
	                    listLI = listLI + '<li id="viscosity75W90"><label><input type="checkbox" name="filters[viscosity][]" value="75W90" <?php if (isset($viscosityArray["75W90"])) {
				echo $viscosityArray["75W90"];
			} ?> >75W90</label></li>';
	                    listLI = listLI + '<li id="viscosity75W140"><label><input type="checkbox" name="filters[viscosity][]" value="75W140" <?php if (isset($viscosityArray["75W140"])) {
				echo $viscosityArray["75W140"];
			} ?> >75W140</label></li>';
	                    $("#viscosityUL").append(listLI);
	                }
	            }
...
<?php if (isset($_SESSION['basket'])) { ?>
	...
	?>
	<?php if (is_array($shopitem['items'])) {
		foreach ($shopitem['items'] as $key => $value) { ?>
