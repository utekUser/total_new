...
<?php
if ($_SERVER['REQUEST_URI'] == "/about/" || $_SERVER['REQUEST_URI'] == "/terms/" || $_SERVER['REQUEST_URI'] == "/kontakty-i-shema-proezda-kompanii-tomavtotrejd-/" || $_SERVER['REQUEST_URI'] == "/guestbook/" || $_SERVER['REQUEST_URI'] == "/vacancy/") {
