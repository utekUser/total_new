...
<div class="list-init">
    ...
    <?php foreach ($this->module as $key => $value) { ?>
      <tr>
        <th><a href="/admin/filters/<?php echo $key; ?>/"><?php echo $value; ?></a></th>
        <td><a href="/admin/filters/<?php echo $key; ?>/add">Добавить</a></td>
        <td><a href="/admin/filters/<?php echo $key; ?>/">Изменить</a></td>
      </tr>
    <?php } ?>
    </table>
</div>
...
<h4>Отчеты о поиске фильтров</h4>
<form method="post" action="/admin/oils/searchoilreport/" target="_blank">
	...
	<input type="hidden" name="typesearch" value="filters" />
