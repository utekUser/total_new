	...
	<?php if (count($this->goods) > 1) : ?>
		<div class="paginator">
			...
			echo $this->paginationControl(
					...
					'Sliding', 
					'user-page.tpl', 
					array('addParam' => "catalog-search-text=" . $_GET['catalog-search-text'] . $addParam)
				); ?>
		</div>
	<?php endif; ?>
	<?php if (!$goods) : ?>
		<p>По запросу 
			<?php if (strlen($_GET['catalog-search-text']) > 0) : ?>
				<strong>&laquo;<?php echo $_GET['catalog-search-text']; ?>&raquo;</strong> 
			<?php endif; ?>
			товар не найден.
		</p>
