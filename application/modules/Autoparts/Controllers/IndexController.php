<?php
class Autoparts_controllers_IndexController extends Core_Controller_Action_User {
    ...
    public function indexAction() {
        ...
        $plugModel = new Autoparts_Models_Autoparts();        
        ...
        if ($request->getQuery('code')) {
        	...
        	$this->view->code = $code;        	
        	if ($codePlug != '') {
        	    $this->view->paginator = $plugModel->getAutoparts($codePlug);
        	} else {
    	       $this->view->paginator = $plugModel->getAutoparts();
        	}
