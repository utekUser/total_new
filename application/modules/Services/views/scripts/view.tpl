<h1><?php echo $this->currentService['name']; ?></h1>
<div class="block-razd"></div>
<div class="chain">
	<a href="/">Главная</a>
	<a href="/services/">Услуги</a>
	<?php echo $this->currentService['name']; ?>
</div>
<div class="block-razd"></div>

<div class="block">
	<div class="block-text spacer">
	<?php echo $this->currentService['text']; ?>
	</div>
</div>
...
<div class="block-razd"></div>
<div class="back"><a href="/services/">Вернуться <img src="/themes/default/images/more.png"></a></div>