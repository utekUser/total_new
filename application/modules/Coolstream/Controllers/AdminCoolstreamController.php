<?php
class Coolstream_Controllers_AdminCoolstreamController extends Core_Controller_Action_Admin {
...
//    }
    ...
    public function deleteAction() {
        ...
        $this->_redirector->gotoActionUrl('/admin/coolstream/');
    }
