<?php
class Plug_controllers_IndexController extends Core_Controller_Action_User {
...
//                $this->view->priceType = 'ngk3';
    ...
    public function indexAction() {
        ...
        if ($request->getQuery('code')) {
        	...
        	if ($codePlug != '') {
        	    $this->view->paginator = $plugModel->getPlugs($codePlug);
        	} else {
    	       $this->view->paginator = $plugModel->getPlugs();
        	}
